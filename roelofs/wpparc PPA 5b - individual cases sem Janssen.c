/****************************************************
 *  wpparc PPA 5b - individual cases sem Janssen.c  *
 *                                                  *
 *  WEAVER++/ARC application to individual cases of *
 *  the semantic variant of primary progressive     *
 *  aphasia (PPA) in the study of                   *
 *  Janssen et al. (2022)                           *
 *                                                  *
 *  Simulation of cases of semantic variant PPA     *
 *                                                  *
 ...
 ****************************************************/
 ...
 Real data for individual cases of semantic variant PPA performing single-word tasks:
...
/*  Real data on semantic variant cases from Janssen et al. (2022) */

 double REAL_DATA[N_ASSESSMENTs][N_TASKs] = {
	      /* Naming  Comprehension Repetition */
	/* 0 */ { 90,   96, 97 }, /* controls */
	/* 1 */ { 40.0,	96.7,	100.0 }, /* patients */
	/* 2 */ { 40.0,	96.7,	80.0 },
	/* 3 */ { 23.3,	93.3,	93.3 },
	/* 4 */ { 6.7,	93.3,	100.0 },
	/* 5 */ { 40.0,	93.3,	100.0 },
 ...
 *********************/
 ...
 void print_heading()
 {
	 ...
	 printf("Simulating single cases of the semantic variant\n");

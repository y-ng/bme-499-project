 /****************************************************
  *  wpparc PPA 4 - case series log Gorno-Tempini.c  *
  *                                                  *
  *  WEAVER++/ARC application to case series study   *
  *  of the logopenic variant of primary progressive *
  *  aphasia (PPA) by Gorno-Tempini et al. (2008)    *
  *                                                  *
  *  Simulation of cases of logopenic variant of PPA *
  *                                                  *
...
Real data for logopenic variant PPA cases performing single-word tasks:
Gorno-Tempini, M. L., Brambati, S. M., Ginex, V., Ogar, J., Dronkers, N. F., 
Marcone, A., Perani, D., Garibotto, V., Cappa, S. F., & Miller, B. L. (2008). 
...
#define N_ASSESSMENTs 7 /* six patients, one control */
...
/* weight lesion */
 ...
 /* Logopenic: connections to and from lexical output forms,
	and between input and output phonemes */

/* decay lesion */
 double DECAY_INCREASE_LOGOPENIC;
 /* output morpheme nodes */
...
void set_aphasic_parameters()
{
  ...
  /* setting of weight parameters, here only for logopenic */
  ...
  if(assessment == NORMAL)
	...
	/* setting of decay parameters, here only for logopenic */
 ...
 *********************/
 ...
 void print_heading()
 {
	 ...
	 printf("Empirical data on individual patients from Gorno-Tempini et al. (2008)\n");

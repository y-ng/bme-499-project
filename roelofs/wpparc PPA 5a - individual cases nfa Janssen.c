 /****************************************************
  *  wpparc PPA 5a - individual cases nfa Janssen.c  *
  *                                                  *
  *  WEAVER++/ARC application to individual cases of *
  *  the nonfluent/agrammatic variant of primary     *
  *  progressive aphasia (PPA) in the study of       *
  *	 Janssen et al. (2022)                           *
  *                                                  *
  *  Simulation of cases of nonfluent/agrammatic PPA *
  *                                                  *
...
Real data for individual cases of nonfluent/agrammatic variant PPA performing single-word tasks:
...
/*  Real data on nonfluent/agrammatic cases from Janssen et al. (2022) */

double REAL_DATA[N_ASSESSMENTs][N_TASKs] = {
	      /* Naming  Comprehension Repetition */
	/* 0 */ {  90,		96,		97 }, /* controls */
	/* 1 */ {  83.3,	93.3,	83.3 }, /* patients */
	/* 2 */ {  80.0,	93.3,	96.7 },
	/* 3 */ {  50.0,	100.0,	73.3 },
	/* 4 */ {  70.0,	93.3,	70.0 },
	/* 5 */ {  63.3,	96.7,	86.7 },
 ...
 *********************/
 ...
 void print_heading()
 {
	 ...
	 printf("Simulating single cases of the nonfluent/agrammatic variant\n");
